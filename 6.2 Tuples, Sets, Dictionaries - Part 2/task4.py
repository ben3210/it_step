...
def delete_data(data_list, info, data):
    ...
    for dat in data_list:
        ...
        print(f"\033[91m{data} not Found!\n(Hint: Type Title correctly - Case Sensitive)\033[0m")#change..................................................
...
def search_data(data_list, info, data):
    ...
    while is_empty_search:
        search = input("Search (Title): ")#change........................................................................
...
info = ["title", "author", "genre", "year", "publisher"]#change........................................................................
data = "Book"#change........................................................................
os.system('cls')

print("\033[1;37;44m Welcome - BOOK COLLECTION APPLICATION \033[0m")#change........................................................................
app_running = True
...
while app_running:
    ...
    elif user == '1': add_data(books, info, data); os.system('pause')
    elif user == '2': delete_data(books, info, data); os.system('pause')
    elif user == '3': search_data(books, info, data); os.system('pause')
    elif user == '4': replace_data(books, info, data); os.system('pause')
    elif user == '5': display_data(books, info); os.system('pause')
